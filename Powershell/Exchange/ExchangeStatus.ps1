...
* MAPI Connectivity
* Outlook Web Acces test-step

.NOTES
* Enter EXTERNAL e-mailaddress when prompted
* Run in a elevated Exchange Shell
* Should be run on each server individually. The script doesn't check every Exchange Server there is automatically.
...
Write-Host "Click any button to open OWA. Make sure that you can login." -ForeGroundColor Yellow
timeout 120 | Out-Null
Start https://localhost/owa
