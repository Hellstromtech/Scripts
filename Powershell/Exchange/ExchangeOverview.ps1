...
There will be two output files "ExchangeReport.csv" & "Mailbox.csv". Both files will be placed on your desktop.

.OUTPUTS
ExchangeReport.csv contains all Exchange configuration
